...
def test_claims_unblocked_up_to_cap_in_id_order(
    ...
    make_issue(6)
    outcome: ClaimOutcome = claim_pass(fake_board, fake_launcher, make_supervisor_config())
...
def test_claim_protocol_order_state_then_tag_then_comment_then_launch(
    ...
    make_issue(5)
    claim_pass(fake_board, fake_launcher, make_supervisor_config())
...
def test_epic_scope_filter_limits_claims(
    ...
    outcome: ClaimOutcome = claim_pass(fake_board, fake_launcher, config)
    assert outcome.claimed == (5,)
