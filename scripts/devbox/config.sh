...
# on the gswa-devbox HOST and nothing else: they never create, start, or deallocate the
# VM. VM lifecycle stays owned by gswa's scripts/devbox/* (migrate-flotilla plan,
